...
const ExploreCard = ({
  ...
  >
    <img
      src={imgUrl}
      alt="planet-04"
      className="absolute h-full w-full rounded-[24px] border-4 border-white object-cover"
    />
    {active !== id ? (
      ...
      <div className="absolute bottom-0 flex w-full flex-col justify-start rounded-b-[24px] bg-[rgba(0,0,0,0.5)] p-8">
        ...
        >
          <img
            src={iconUrl}
            alt="muzicscale courses"
            className="h-1/2 w-1/2 object-contain"
          />
        </div>
        <p className="text-[16px] font-light uppercase leading-[20.16px] text-white">
          Learn
        </p>
