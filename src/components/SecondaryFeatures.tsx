...
import curriculum from '@/public/assets/images/curriculum.png';
import personalizedClass from '@/public/assets/images/personailzed.png';
import tailored from '@/public/assets/images/tailored.png';

const features = [
  {
    name: 'Personalized 1-1 Sessions',
    summary:
  ...
  {
    name: 'Tailored Curriculum',
    summary: 'Customized learning plans to achieve your musical goals.',
    description:
  ...
  {
    name: 'Simplified Concepts for Comprehensive Understanding',
    summary: 'Easily grasp complex music theory and concepts.',
    description:
...
function Feature({ feature, isActive, className, ...props }) {
  return (
    ...
    >
      ...
      <p className="mt-2 text-xl font-light text-slate-900">
        {feature.summary}
      </p>
      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            Embark on a musical journey like no other and unleash your true
            musical talent with our unparalleled features.
          </p>
        </div>
        <FeaturesMobile />
        <FeaturesDesktop />
